...
<?php
    ...
    $twitter_account = apply_filters('theme_twitter_account', '@ARMADABOLIVIANA');
    if ($twitter_account) {
?>
...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://www.facebook.com/laarmada.enaccion","https://twitter.com/ARMADABOLIVIANA","https://www.instagram.com/armadaboliviana_oficial/"));
    ...
    $logo = theme_get_logo(array('default_src' => "/images/ArmadaAB.png", 'default_url' => ''));
    if (!empty($logo['src'])) {
...
function theme_color_meta_tags() {
    $theme_color = apply_filters('theme_color', '#52576c');
