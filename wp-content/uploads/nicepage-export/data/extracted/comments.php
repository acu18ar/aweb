...
<section class="u-align-center u-clearfix u-section-1" id="sec-bbaf">
		...
		<?php if ( have_comments() ) : ?>
			<h3 class="comments-title">
				...
				if ( 1 === $comments_number ) {
					...
					printf( _x( 'One thought on &ldquo;%s&rdquo;', 'comments title', 'wp1' ), get_the_title() );
				} else {
					printf(
